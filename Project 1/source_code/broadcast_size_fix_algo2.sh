...
# Algorithm n 2 -->
echo "idx_process,dimension_size,Latency" > ../results/broadcast_algo2_fixed_core_secondpart.csv # CSV file to store results

# Looping over the n of idx_process
for idx_process in {243..256} # from 2 to 256 tasks (128 per node)
do
    ...
    echo "$idx_process,$dimension_size,$result_broadcast2" >> ../results/broadcast_algo2_fixed_core_secondpart.csv # CSV file to store results
done
# end algo 2
